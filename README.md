...
- **Frontend web developer at ELITX Technologies, Abbottabad** 
  - Transformed Figma designs into responsive web interfaces using HTML, CSS, and JavaScript. 
  -  Participated in a project focused on application reports, utilizing React.js, Material UI, and a 
combination of GraphQL queries, mutations, and REST APIs to deliver comprehensive 
reporting functionality. 
  - Worked collaboratively on a web-based radio management application, employing React.js, 
Bootstrap, and REST APIs to create a user-friendly and efficient system.
...
a Lexical Text Editor and Styled Components for enhanced customization and user experience. 
  - Created a Notes app with React.js to help users organize and improve productivity by 
...
Feel free to reach me via email at [hassankhan12425@gmail.com](mailto:hassankhan12425@gmail.com) or connect with me on [LinkedIn](https://www.linkedin.com/in/hassan-khan-67819122a/), [Upwork](https://www.upwork.com/freelancers/hassank9).

---

⭐️ From [hassankhan](https://github.com/Hassan12425)
